...
{
    public class InterfacePreference : TreeItem, IPreference, ITreeItem
    {
        ...
        /// </summary>
        public string Title { get { return "Interface"; } }
        ...
        {
            writer.WriteStartElement(nameof(InterfacePreference));
        ...
        public static InterfacePreference Load(XmlNode node)
        {
            InterfacePreference preference = new InterfacePreference();
